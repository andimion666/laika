...
uint256 hashGenesisBlock("0x00000000aee8a36d08de895ba44ee61924ef3cdf2bbb80ea4942692aa64f9602");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 400 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 400);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 2 * 60 * 60; // two weeks
static const int64 nTargetSpacing = 5 * 20;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1524151437;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 1187211438;
        ...
        assert(block.hashMerkleRoot == uint256("0410191ecb81668ab68f707ee4e105242fd776ff34a99206fb9717b00135038a"));
        block.print();
